...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \textbf{\href{https://cit-ai.net}{Computer Science and Engineering, City}, UK}
  \begin{outerlist}
  \item[\textit{Affiliated Researcher}] \hfill \textbf{2019--}
  \item{CitAI, Artificial Intelligence Research Centre}
  \end{outerlist}
  \vspace{10pt}
...
\textbf{Upcoming}: Inria and the Institute of Neurodegenerative Diseases, Bordeaux, France, September 2019; \href{https://openmrbenelux.github.io/}{OpenMR} Benelux, Leiden, The Netherlands, January 2020.
\vspace{10pt}

\textbf{\href{http://www.rise.org.cy/en-gb/}{Research Centre on Interactive Media, Smart Systems and Emerging Technologies (RISE)}}
\begin{outerlist}
