...
\begin{outerlist}
 ...
 \item[\textbf{Donders Centre for Cognition, Radboud University}] \hfill
 \begin{innerlist}
   \item[\textbf{Netherlands}, \textit{Assistant Professor}] \hfill\textbf{2021--}
     \end{innerlist}
     
 \item[\textbf{Donders Centre for Cognitive Neuroimaging, Radboud University}] \hfill
 \begin{innerlist}
   \item[\textbf{Netherlands}, \textit{Postdoctoral Researcher}] \hfill\textbf{2020--2021}
     \end{innerlist}
...
\begin{outerlist}
   \item[\textbf{\href{https://joss.theoj.org/}{The Journal of Open Source Software}} --- \textit{Joint Editor-in-Chief}] \hfill \textbf{2022--}
   ...
   \item[\textbf{\href{https://joss.theoj.org/}{The Journal of Open Source Software}} --- \textit{Topic Editor}] \hfill \textbf{2019--2022}
   ...
   \begin{innerlist}
         \item[] Co-edited special issue of ReScience C.
   \end{innerlist}
...
\begin{outerlist}
   ...
   % \item[\textbf{Donders Centre for Cognition, Radboud University, Netherlands, Assistant Professor}] \hfill \textbf{2021--}
  ...
  \end{innerlist}
    ...
    \item[\textbf{Department of Experimental Psychology, University of Oxford, Postdoc}] \hfill \textbf{2014--2016}
      \begin{innerlist}
        \item mentored PhD candidates.
        \item trained PhD candidates in computational modeling and programming.
  \end{innerlist}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{MANUSCRIPTS (under review, revision, or in prep)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paper{\textbf{Guest, O.} (in prep) What makes a good scientific theory? \textit{Invited for Lorentz workshop special issue of Computational Brain \& Behavior}
}{}


\paper{van Rooij, I.,  \textbf{Guest, O.}, Adolfi, F., Kolokolova, A., \& Rich, P. (in prep) Reclaiming AI as theoretical tool for cognitive science. \textit{Invited for Lorentz workshop special issue of Computational Brain \& Behavior}
}{}

\paper{Rich, P., Adolfi, F., Field, S. M., Fusaroli, R., \textbf{Guest, O.}, Hartley, T., Nuñez Hernandez, N. A., van de Braak, L., van Rooij, Iris (in prep) The Role of Community in Theoretical Research. \textit{Invited for Lorentz workshop special issue of Computational Brain \& Behavior}
}{}

\paper{Teaching about theorising; theorising about teaching (in prep) Fusaroli R., De Santo, A., \textbf{Guest, O.}, Woensdregt, M., Adolfi, F., Todorovikj, S., Vermillet, A.-Q., Hartley, T., van Rooij, I., Skewes, J. \textit{Invited for Lorentz workshop special issue of Computational Brain \& Behavior}
}{}



\paper{Zgonnikov, A., Thill, S., Fau, P. B., Jonker, C. M., \textbf{Guest, O.} (in prep) Modeling Human Behavior in HRI: Why, What, and How. }{}

\paper{Erscoi, L. A., Kleinherenbrink, A., \& \textbf{Guest, O.} (in prep) My Fair AI: Humanising Artificial Intelligence by Dehumanising Women.
}{}

\paper{\textbf{Guest, O.}, van Rooij, I., \& Martin, A. E. (in prep; invited to special issue) What are our models really, and are models real? How metatheoretical calculi can obtain in cognitive computational neuroscience (2022). \textit{Synthese}. %\newline
% \href{https://doi.org/10.48550/arXiv.2202.08674}{doi.org/10.48550/arXiv.2202.08674}
}{}

\paper{ \textbf{Guest, O.}  \& Martin, A. E. (revise \& resubmit) On logical inference over brains, behaviour, and artificial neural networks. \textit{Computational Brain \& Behavior}. \newline
\href{https://doi.org/10.31234/osf.io/tbmcg}{doi.org/10.31234/osf.io/tbmcg}}{}



\paper{Forbes, S. H., Aneja, P., \& \textbf{Guest, O.} (accepted in special issue). The Myth of Normative Development. \textit{Infant and Child Development}. \newline
\href{https://doi.org/10.31234/osf.io/ajynp}{doi.org/10.31234/osf.io/ajynp}}{}
...
% \vspace{10pt}
\paper{
Levitis, E. et al. (2021). {Centering inclusivity in the design of online conferences—An OHBM–Open Science perspective. \textit{Gigascience.}}\newline
 \href{https://doi.org/10.1093/gigascience/giab051}{doi.org/10.1093/gigascience/giab051}
}{}
...
\section{PREPRINTS}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%separate into preprints, proceedings, and magazines
...
\item [\textbf{\href{}{Aarhus Education Collaboration}}:] \euro 40,000 \hfill \textbf{2022--}
 
\begin{innerlist}
  \item Radboud-Aarhus theoretical modelling internship (with Joshua Skewes)

 \end{innerlist}

\item [\textbf{\href{https://www.ru.nl/radboudinternational/english/internationalisation/radboud-western-collaboration-fund/}{Western-Radboud Collaboration Fund (co-applicant)}}] \hfill \textbf{2022--}
 
\begin{innerlist}
  \item Partner in collaboration on governance of artificial intelligence (AI) systems.

 \end{innerlist}
 
% \item [\textbf{\href{https://ru.nl}{DCC Student Assistantship Funding}}] \hfill \textbf{2022}
 
%\begin{innerlist}
%  \item Funding for mentoring a student assistant for a project on multiple realisability; to aid in creation of a computer simulation environment.
% \end{innerlist}
 


\item[\textbf{\href{https://shuttleworthfoundation.org/fellows/flash-grants/}{Shuttleworth Foundation Flash Grant}}: \$5,000] \hfill \textbf{2021}
\begin{innerlist}
  \item Funding is in recognition of my work as a ``social change agent'', based on nominations from Shuttleworth Flash Fellows.
\end{innerlist}

\item [\textbf{\href{https://ru.nl}{Nomination for Faculty of Social Sciences Junior Education Prize}}] \hfill \textbf{2021}
 
\begin{innerlist}
  \item Nominated by the student representatives of the BSc Degree Programme Committee.
 \end{innerlist}


\item[\textbf{\href{https://www.software.ac.uk/about/fellows/olivia-guest}{Software Sustainability Institute Fellowship}}: £3,000] \hfill \textbf{2017}
...
\textbf{\href{https://www.ru.nl/courseguides/socsci/bachelor/artificial-intelligence/ai-department/who-we/}{School of Artificial Intelligence}, \href{https://ru.nl}{Radboud}, NL}
\begin{outerlist}
    \item[Assistant Professor] \hfill \textbf{2021--}
    \item[Postdoctoral Research Assistant] \hfill \textbf{2021}
    \item[\textit{\href{https://www.ru.nl/courseguides/socsci/courses-osiris/ai/sow-bki332-ai-science/}{AI as a Science}}] \
  \begin{innerlist}
    \item Module: 3EC \textit{Third Year, B.Sc.}
    \item Designed course from the ground up.
    \item Redesigned course (since in its 2nd year it has 10 times the students; from 5 to 50).
  \end{innerlist}
      \item[\textit{\href{https://www.ru.nl/courseguides/socsci/courses-osiris/ai/sow-mki56-theoretical-foundations-for-cognitive/}{Theoretical Foundations for Cognitive Agents}}] \
  \begin{innerlist}
    \item Module: 6EC \textit{M.Sc.}
    \item Redesigned course from the ground up.
  \end{innerlist}
\end{outerlist}
\vspace{8pt}
...
\item[\textbf{Diversity, Equity and Inclusion in Artificial Intelligence} (0.2fte, 8 hours/week)] \hfill \textbf{2022--}

\item[\textbf{Track leader of (prospective) CompCogSci MSc AI subspecialisation}] \hfill \textbf{2022--}

\item[\textbf{Member of Master's Artificial Intelligence Degree Programme Committee}] \hfill \textbf{2022--}

\item[\textbf{Member of evaluation committee for Internal DCC PhD round 2022}] \hfill \textbf{2022}
\end{outerlist}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{SELECTED INVITED\texorpdfstring{\newline}{ }TALKS, PANELS \& WORKSHOPS}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\textbf{\href{https://www.lorentzcenter.nl/what-makes-a-good-theory-interdisciplinary-perspectives.html}{What makes a good theory? Interdisciplinary Perspectives}} 
\begin{outerlist}
  \item[] \textit{Leiden, NL}\hfill\textbf{20--24 Jun 2022}
  \begin{innerlist}
    ...
    \item Organisers: Iris van Rooij, Todd Wareham, Berna Devezer, Sashank Varma, and Joshua Skewes
  \end{innerlist}
\end{outerlist}
\vspace{8pt}
...
\begin{outerlist}
  ...
  \begin{innerlist}
    ...
    % \item Panel members: Eliana Colunga, Andy Perfors, and myself.
  \end{innerlist}
\end{outerlist}
\vspace{8pt}
\begin{samepage}
...
\section{MAINSTREAM MEDIA \& OUTREACH}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{-10pt}
...
\vspace{-6pt}
 ...
 \item[\textbf{Conferences (ad hoc reviewing)}] \hfill
   ...
   \item[\textbf{Journals (ad hoc reviewing)}] \hfill
          \begin{innerlist}
          \item [] Cognitive Neuropsychology,  Cognitive Psychology, Cognitive Science Journal, Journal of Cognitive Neuroscience, Journal of Open Source Education, Memory \& Cognition, PeerJ, PLoS Computational Biology, Royal Society Open Science, Topics in Cognitive Science.
        \end{innerlist}
