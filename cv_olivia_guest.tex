...
\begin{outerlist}
  ...
  \begin{innerlist}
    ...
    \item  Marked essays for Cognitive and Decision Sciences M.Sc.
  \end{innerlist}
  \end{outerlist}
  \vspace{15pt}
  ...
  \begin{innerlist}
    \item    £3,000 grant funding for travel and organising workshops.
...
\vspace{-10pt}
\begin{outerlist}
   \item[\textbf{\href{http://rescience.github.io/}{ReScience Journal}} --- \textit{Editor-in-Chief}] \hfill \textbf{2020--}
   
   \item[\textbf{\href{https://joss.theoj.org/}{The Journal of Open Source Software}} --- \textit{Topic Editor}] \hfill \textbf{2019--}

   \item[\textbf{\href{http://rescience.github.io/}{ReScience Journal}} --- \textit{Associate Editor}] \hfill \textbf{2015--2020}
   
 \item[\textbf{Ad hoc}] \hfill
 
  International Conference on Cognitive Modelling (ICCM), International Conference on Machine Learning (ICML), Scientific Computing with Python Conference (SciPy), Cognitive Science Journal, Cognitive Psychology, Memory \& Cognition, PLOS Computational Biology.
 \end{outerlist}
...
\textbf{Guest, O.} \& Martin, A. E. (in prep; invited to special issue).  {How computational modeling can force theory building in psychological science}. \textit{Perspectives on Psychological Science}.
\vspace{7.5pt}


\textbf{Guest, O.} et al. (in prep; for special issue). {Can ``open science'' make science open?}. \textit{Psychology of Women Quarterly}.
\vspace{7.5pt}

Bobadilla Suarez, S., \textbf{Guest, O.} \& Love, B. C. (in prep; available on request).  {The neural link between subjective value and decision entropy}.
\vspace{7.5pt}


\textbf{Guest, O.}, Caso A. \& Cooper, R. P. (under review; available on request).  {On Simulating Neural Damage in Connectionist Networks}. \textit{Computational Brain \& Behaviour}
\vspace{7.5pt}

Botvinik-Nezer, R. et al. (revise \& resubmit). \href{https://doi.org/10.1101/843193}{Variability in the analysis of a single neuroimaging dataset by many teams}. \textit{Nature}.
\vspace{7.5pt}

Whitaker, K. J. \& \textbf{Guest, O.} (in press).  {\#bropenscience is broken science}. \textit{The Psychologist}.
\vspace{7.5pt}

Botvinik-Nezer, R. et al. (2019). \href{https://doi.org/10.1101/843193}{Variability in the analysis of a single neuroimaging dataset by many teams.}  \textit{bioRxiv}.
\vspace{7.5pt}
...
\textbf{\href{}{MathPsych/ICCM 2020}}
\begin{outerlist}
