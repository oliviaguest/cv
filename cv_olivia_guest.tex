...
\begin{innerlist}
  \item Designed and obtained funding for mentoring a student assistant for a project on multiple realisability; to aid in creation of a computer simulation environment.
 \end{innerlist}
...
\paper{Erscoi, L. A., Kleinherenbrink, A., \& \textbf{Guest, O.} (in prep) My Fair AI; from Pygmalion to the Present (2022). % \textit{Synthese}. %\newline
...
\paper{Forbes, S. H., Aneja, P., \& \textbf{Guest, O.} (under review in special issue). The Myth of Normative Development. \textit{Infant and Child Development}. \newline
